...
public class gethitomi {
    ...
    void get_preview(String key, int page_number, File file) throws Exception{
        ...
        String postfix = hash.substring(hash.length()-3);
        String hitomiurl ="https://btn.hitomi.la/webpbigtn"  + "/" + postfix.charAt(2) +"/" + "/"  + postfix.charAt(0) + postfix.charAt(1) + "/" +  hash + ".webp" ;
